...
<head>
    ...
    <script type="text/javascript" src="/public/user/js/jquery.windstagball.js"></script>
    <style type="text/css">
        body {background: #FFF }
        #divcloud {position:relative; width:320px; height:320px; border:0px solid #000; margin: 20px auto 0; }
        #divcloud a {position:absolute; top:0px; left:0px; font-family: Microsoft YaHei; color:#000; font-weight:bold; text-decoration:none; padding: 3px 6px; }
        #divcloud a:hover {border: 1px solid #eee; background: #FFF; }
...
<header class="mod-head">
    <div class="mod-head__logo">
        <a href="<?php echo site_url();?>">
            <img class="avatar" src="<?php echo base_url('/public/image/headimage.png');?>" alt="" width="26" height="26" onMouseOver="javascript:show();" onMouseOut="hide()"></a>
    </div>
    ...
    <div id="right-panel" class="panel">
        <ul id="menu-%e8%8f%9c%e5%8d%95-1" class="ymod-head">
            ...
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-15"><a href="<?php echo site_url('/tags');?>">Tags</a></li>
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-15"><a href="<?php echo site_url('/links');?>">Links</a></li>
